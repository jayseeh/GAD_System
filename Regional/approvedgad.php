...
<h2>APPROVED FORMS</h2>
      ...
      <?php
        ...
        $sql="SELECT * FROM gad_form INNER JOIN caps ON gad_form.approver_id=caps.id WHERE form_status='APPROVED' and form_number LIKE '%GAD%' AND gad_form.date_submitted >= '$fiscal_start' and gad_form.date_submitted <= '$fiscal_end' ORDER BY date_submitted";
