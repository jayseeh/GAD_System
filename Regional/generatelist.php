...
<div class="container-fluid">
   ...
   <a class="btn btn-warning rounded-pill" href="print-list.php?id=<?php echo $form_type; ?>" target="_blank">Print</a>
  <br><br>
<div class="d-flex justify-content-center">
    <fieldset>
...
<div class="card" style="width: 70rem;">
  ...
  <div class="card-body">
      ...
      <?php
        ...
        $sql="SELECT * FROM gad_form INNER JOIN caps ON gad_form.approver_id=caps.id WHERE form_status='APPROVED' and form_number LIKE '%".$form_type."%' AND gad_form.date_submitted >= '$fiscal_start' and gad_form.date_submitted <= '$fiscal_end'ORDER BY date_submitted";
