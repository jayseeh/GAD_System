 ...
 <a href="regional.php" class="btn rounded-pill" style="background-color: #3366ff; color: white;">Home</a>
   <?php
    if($form_type=='GPB'){
      ...
      echo '<a href="approvedgad.php" class="btn btn-success rounded-pill">Go Back</a>';
    }
  ?>
  </div> 
  <br>
  ...
  <div class="card-body">
   ...
   <div class="mb-3">
    ...
    <label  class="col-sm-0 col-form-label">Status</label><br>
    <div class="col-sm-0">
    ...
    <div class="col-sm-0">  
      ...
      <table class="table table-bordered" id="table_gad">
        <tr>
            ...
            <th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class="fonts-fam">Gender Issue/GAD Mandate</th>          
            <th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class="fonts-fam">Cause of the Gender Issue</th>
            <th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class="fonts-fam">GAD Result Statement/GAD Objective</th>
            <th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class="fonts-fam">Relevant Organization MFO/PAP</th>
            <th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class="fonts-fam">GAD Activity</th>
            <th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class="fonts-fam"><?php echo ($form_type == 'GPB') ? 'Output Performance Indicator/ Target' : 'Performance Indicator'; ?></th>
            <th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class="fonts-fam"><?php echo ($form_type == 'GPB') ? 'GAD Budget' : 'Actual Result (Outputs/Outcomes)'; ?></th>
            <th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class="fonts-fam"><?php echo ($form_type == 'GPB') ? 'Source of Budget' : 'Total Agency Approved Budget'; ?></th>
            <th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class="fonts-fam"><?php echo ($form_type == 'GPB') ? 'Responsible Unit/ Office' : 'Actual Cost/ Expenditure'; ?></th>   
            <?php
              if($form_type=='GAD'){
                echo "<th style='padding: 2px; background-color: #3366ff; color: white; border-bottom: 2px solid black;' class='fonts-fam'>Variance/ Remarks</th>";
              }
            ?>
