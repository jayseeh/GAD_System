                   ...
                   $result=mysqli_query($conn, $sql);
                       ?>
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th style="padding: 10px; background-color: #3366ff; color: white; border-bottom: 2px solid black;"><h4>Division</h4></th>

                                        <th style="padding: 10px; background-color: #3366ff; color: white; border-bottom: 2px solid black;"><h4>Reports</h4></th>
                                ...
                                <tr>
                                    ...
                                    <td><a href="../Regional/Reports/<?php echo $row['filename']; ?>" download>Download</a></td>
