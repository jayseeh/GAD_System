...
<h2>PENDING FORMS</h2>
      ...
      <?php
        ...
        $sql="SELECT * FROM gad_form INNER JOIN caps ON gad_form.requestor_id=caps.id WHERE form_status='PENDING' and form_number LIKE '%GAD%' AND date_submitted >= '$fiscal_start' and date_submitted <= '$fiscal_end'ORDER BY date_submitted";
