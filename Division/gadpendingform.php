...
<h2>PENDING GAD AR FORMS</h2>
      ...
      <?php
        ...
        $sql="SELECT * FROM gad_form WHERE requestor_id='$user' and form_number LIKE 'GAD%' and (form_status='PENDING' or form_status='ACTION REQUIRED') ORDER BY date_submitted";
