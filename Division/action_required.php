...
<div class="card text-center" style="width: 72rem;">
 ...
 <h2>ACTION REQUIRED FORMS</h2>
      ...
      <?php
        ...
        $sql="SELECT * FROM gad_form WHERE requestor_id='$user' and form_number LIKE 'GPB%' and (form_status='ACTION REQUIRED') AND date_submitted >= '$fiscal_start' and date_submitted <= '$fiscal_end' ORDER BY date_submitted";
