...
$query = mysqli_query($conn,"SELECT * FROM gad_form INNER JOIN gad_table_entry_value ON gad_form.form_number=gad_table_entry_value.form_number WHERE gad_table_entry_value.category_focused='ORGANIZATION' AND gad_form.form_number LIKE '%GPB%' AND gad_form.date_submitted >= '$fiscal_start' and gad_form.date_submitted <= '$fiscal_end' and gad_form.requestor_id='$user' ORDER BY gad_form.form_number");  
